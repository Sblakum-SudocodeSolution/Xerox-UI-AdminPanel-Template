...
export default function Passport({ nextStep }) {
    ...
    let { passportNumber, userName, dob, birthPlace, issuePlace, nationality, doi, doe } = inputVal;
    ...
    const Continue = (e) => {
        ...
        axios.post('https://642141a734d6cd4ebd6e8cdc.mockapi.io/passport', inputVal).then(() =>
            setInputVal({
                passportNumber: '',
                userName: '',
                dob: '',
                            ...
                            <Form className="mt-5" autoComplete="off" onSubmit={Continue}>
                                ...
                                <Row className="mb-3">
                                    <Form.Group as={Col} controlId="formGridState">
                                        ...
                                        <Form.Control type="date" name="dob" value={dob} onChange={(e) => handleChange(e)} required />
                                    </Form.Group>
                                ...
                                <Row className="mb-3">
                                    <Form.Group as={Col} controlId="formGridState">
                                        ...
                                        <Form.Control type="date" name="doi" value={doi} onChange={(e) => handleChange(e)} required />
                                    </Form.Group>

                                    <Form.Group as={Col} controlId="formGridZip">
                                        <Form.Label className="d-flex flex-row">Date Of Expire</Form.Label>
                                        <Form.Control type="date" name="doe" value={doe} onChange={(e) => handleChange(e)} required />
                                    </Form.Group>
                                </Row>
